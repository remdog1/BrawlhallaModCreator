...
if os.environ.get("BMOD_PYINSTALLER_ANALYSIS") == "1":
    def JClass(name):
        return type(name.rsplit(".", 1)[-1].replace("$", "_"), (), {})
else:
...
LinkedHashSet = JClass("java.util.LinkedHashSet")
...
ActionScript3Parser = JClass('com.jpexs.decompiler.flash.abc.avm2.parser.script.ActionScript3Parser')
AbcIndexing = JClass('com.jpexs.decompiler.flash.abc.avm2.parser.script.AbcIndexing')
ABC = JClass('com.jpexs.decompiler.flash.abc.ABC')
InstanceInfo = JClass('com.jpexs.decompiler.flash.abc.types.InstanceInfo')
TraitClass = JClass('com.jpexs.decompiler.flash.abc.types.traits.TraitClass')
ScriptPack = JClass('com.jpexs.decompiler.flash.abc.ScriptPack')
ABCContainerTag = JClass('com.jpexs.decompiler.flash.tags.ABCContainerTag')
DottedChain = JClass('com.jpexs.decompiler.graph.DottedChain')
IdentifiersDeobfuscation = JClass('com.jpexs.decompiler.flash.IdentifiersDeobfuscation')
...
CSMTextSettingsTag = JClass('com.jpexs.decompiler.flash.tags.CSMSettingsTag')
...
DoABCTag = JClass("com.jpexs.decompiler.flash.tags.DoABCTag")
DoABC2Tag = JClass("com.jpexs.decompiler.flash.tags.DoABC2Tag")
